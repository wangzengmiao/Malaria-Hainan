...
glm2=glm.nb((inci)~log(popu)+log(GDP)+mediratio+cropland+grassland,data=train)
glm3=glm.nb((inci)~log(popu)+log(GDP)+mediratio,data=train)
glm4=glm.nb((inci)~log(popu)+cropland+grassland,data=train)
glm5=glm.nb((inci)~(log(popu))+R0,data=train)
glm6=glm.nb((inci)~R0,data=train)
glm7=glm.nb((inci)~R0+log(GDP)+mediratio+cropland+grassland+(log(popu)),data=train)
...
glm11=glm.nb((inci)~R0+cropland+grassland+log(popu),data=train)


glm2=glm.nb((case)~offset(log(popu))+log(GDP)+mediratio+cropland+grassland,data=train)
glm3=glm.nb((case)~offset(log(popu))+log(GDP)+mediratio,data=train)
glm4=glm.nb((case)~offset(log(popu))+cropland+grassland,data=train)
glm5=glm.nb((case)~offset(log(popu))+R0,data=train)
glm6=glm.nb((case)~R0,data=train)
glm7=glm.nb((case)~R0+log(GDP)+mediratio+cropland+grassland+offset(log(popu)),data=train)
...
glm11=glm.nb((case)~R0+cropland+grassland+offset(log(popu)),data=train)
